...
**Description**: Returns stages for an onboarding process, ordered by display order. Includes Label__c, Next_Stage__c, Required__c, and component library relationship.

**Parameters:**
- `processId` (Id) - Onboarding Application Process ID

**Returns**: List of Onboarding_Application_Stage__c records with:
...
**Returns**: Onboarding_Application_Process__c record
...
**Returns**: Onboarding_Application_Progress__c ID
...
**Returns**: Onboarding_Application_Progress__c record
...
**Returns**: Onboarding_Application_Process__c ID
...
**Returns**: List of Onboarding_Status_Rule__c records
...
**Parameters:**
- `rule` (Onboarding_Status_Rule__c) - Rule record

**Returns**: Onboarding_Status_Rule__c record
...
**Returns**: Map of Vendor Program Requirement ID to Onboarding_Requirement__c
...
**Description**: Gets group IDs for a vendor program by querying Vendor_Program_Group_Member__c records.

**Parameters:**
- `vendorProgramId` (Id) - Vendor Program ID (Vendor_Customization__c)
...
**Returns**: List of Onboarding_Status_Rules_Engine__c records with child `Onboarding_Status_Rules__r` relationship populated

**Fields Returned:**
- `Id`, `Evaluation_Logic__c`, `Custom_Evaluation_Logic__c`, `Override_Status__c`
- Child relationship: `Onboarding_Status_Rules__r` (Id, Rule_Number__c, Requirement__c, Expected_Status__c)
...
**Parameters:**
- `onboarding` (Onboarding__c) - Onboarding record to evaluate
...
**Parameters:**
- `rule` (Onboarding_Status_Rules_Engine__c) - Rule to evaluate
- `reqByVPR` (Map<Id, Onboarding_Requirement__c>) - Requirements mapped by VPR ID
...
- `requirementGroupId` (Id) - Requirement Group ID (Vendor_Program_Requirement_Group__c)

**Returns**: List of Onboarding_Status_Rules_Engine__c records
...
**Parameters:**
- `rules` (List<Onboarding_Status_Rule__c>) - Rules to save
...
**Parameters:**
- `vendorProgramId` (Id) - Vendor_Customization__c ID

**Returns**: List of Required_Credential__c records
...
**Returns**: List of External_Contact_Credential_Type__c records
...
**Returns**: Created External_Contact_Credential_Type__c record
...
**Parameters:**
- `requiredCredentialId` (Id) - Required_Credential__c ID
- `credentialTypeId` (Id) - External_Contact_Credential_Type__c ID
...
**Description**: Activates a versioned record (vendor program, etc.).

**Parameters:**
- `recordId` (Id) - Record ID to activate
- `objectApiName` (String) - Object API name (e.g., 'Vendor_Customization__c')

**Dependencies:**
- Delegates to `OnboardingAppActivationOrchestrator.activate()`
...
**Description**: Activates a record with validation.
